    ...
    <section class="max-w-[640px] w-full min-h-screen mx-auto flex flex-col bg-white overflow-x-hidden pb-[134px]">
        ...
        <div id="popular-fundrising" class="mt-8">
            <div class="px-4 flex justify-between items-center">
                <h2 class="font-bold text-lg">Categories <br></h2>
            ...
            <div class="main-carousel mt-[14px]">
                ...
                @empty
                    <div class="card">
                        <div
                            class="w-full p-[14px] rounded-2xl bg-white text-center flex items-center justify-center h-[100px]">
        ...
        <div id="latest-fundrising" class="mt-8">
            ...
            <div class="flex flex-col gap-4 mt-[14px] px-4">
                ...
                @empty
                    <div class="card">
                        <div class="w-full p-[14px] rounded-2xl bg-white h-[100px]">
                            <h1 class="text-dark text-2xl">No Data Found</h1>
                        </div>
                    </div>
                @endforelse
