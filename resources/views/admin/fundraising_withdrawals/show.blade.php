    ...
    <div class="pt-6">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                <h3 class="text-indigo-950 text-3xl font-bold mb-5 text-center dark:text-white">Request for Withdrawal</h3>
                ...
                <div class="flex flex-row gap-x-10">
                    ...
                    <div>
                        ...
                        <h3 class="text-indigo-950 text-xl font-bold dark:text-white">{{ $fundraisingWithdrawal->bank_account_number }}
                        </h3>
                    </div>
                    <div>
                        <p class="text-slate-500 text-sm dark:text-white">Account Name</p>
                        <h3 class="text-indigo-950 text-xl font-bold dark:text-white">{{ $fundraisingWithdrawal->bank_account_name }}
                        </h3>
                    </div>
                    {{-- <div>
                ...
                @endif
                @if (!$fundraisingWithdrawal->has_received)
                    <h3 class="text-indigo-950 text-xl font-bold dark:text-white">Sedang di proses oleh fundraiser</h3>
                @else
